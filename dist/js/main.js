...
// Module
exports.push([module.i, "html,\nbody {\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  padding: 0;\n}\nhtml .game,\nbody .game {\n  width: 100%;\n  height: 100%;\n  position: relative;\n}\nhtml .game .game-tips,\nbody .game .game-tips {\n  width: 500px;\n  height: 100px;\n  position: absolute;\n  z-index: 6;\n  top: 0px;\n  left: calc(50% - 250px);\n  display: block;\n  color: #f40;\n  font-size: 20px;\n  font-weight: bold;\n  text-align: center;\n  line-height: 100px;\n}\nhtml .game .game-box,\nbody .game .game-box {\n  width: 500px;\n  height: 500px;\n  position: absolute;\n  z-index: 5;\n  top: calc(50% - 250px);\n  left: calc(50% - 250px);\n  background-color: #000;\n}\nhtml .game .game-box .item,\nbody .game .game-box .item {\n  width: 10px;\n  height: 10px;\n  position: absolute;\n  border-radius: 50%;\n  background-color: #fff;\n}\nhtml .game .game-box .head,\nbody .game .game-box .head {\n  width: 10px;\n  height: 10px;\n  position: absolute;\n  border-radius: 50%;\n  background-color: #abcdef;\n}\nhtml .game .game-box .food,\nbody .game .game-box .food {\n  width: 10px;\n  height: 10px;\n  position: absolute;\n  border-radius: 50%;\n  background-color: #f40;\n}\nhtml .game .cover-page,\nbody .game .cover-page {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  z-index: 8;\n  background-color: #fff;\n  color: #000;\n  font-size: 30px;\n  font-weight: bold;\n  padding-top: 200px;\n  box-sizing: border-box;\n  text-align: center;\n  display: none;\n}\nhtml .game .author-box,\nbody .game .author-box {\n  width: 500px;\n  height: 100px;\n  color: 000;\n  font-size: 25px;\n  line-height: 100px;\n  text-align: center;\n  font-weight: bold;\n  position: absolute;\n  bottom: 0px;\n  right: 0px;\n}\n", ""]);
// Exports
...
/* harmony import */ var _snakeBuildClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./snakeBuildClass */ "./src/js/snakeBuildClass.js");
/* harmony import */ var _foodClass_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./foodClass.js */ "./src/js/foodClass.js");



var startKey = false;
var gameTips = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.game-tips');
var food = new _foodClass_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
food.initFood();
...
window.onkeydown = function (e) {
  ...
  } else if (startKey && e.keyCode === 38) {
    snake.changeDirection('top');
    snake.move();
  } else if (startKey && e.keyCode === 40) {
    snake.changeDirection('bottom');
    snake.move();
  } else if (startKey && e.keyCode === 37) {
    snake.changeDirection('left');
    snake.move();
  } else if (startKey && e.keyCode === 39) {
...
/* harmony import */ var _baseConfig_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./baseConfig.js */ "./src/js/baseConfig.js");
...
var gameBox = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.game-box');
...
var Food = /*#__PURE__*/function () {
  function Food() {
    ...
    this.x = null;
    this.y = null;
    this.dom = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div>');
  }
  ...
  _createClass(Food, [{
    ...
    value: function initFood() {
      ...
      this.dom.css({
        'left': "".concat(this.x * _baseConfig_js__WEBPACK_IMPORTED_MODULE_2__["default"].size, "px"),
        'top': "".concat(this.y * _baseConfig_js__WEBPACK_IMPORTED_MODULE_2__["default"].size, "px")
      });
      gameBox.append(this.dom);
    }
  }]);
...
/* harmony import */ var _snakeItemClass_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./snakeItemClass.js */ "./src/js/snakeItemClass.js");
/* harmony import */ var _baseConfig_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./baseConfig.js */ "./src/js/baseConfig.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _foodClass_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./foodClass.js */ "./src/js/foodClass.js");
...
var gameTips = jquery__WEBPACK_IMPORTED_MODULE_4___default()('.game-tips');
var food = new _foodClass_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

var Snake = /*#__PURE__*/function () {
  function Snake(foodx, foody) {
    _classCallCheck(this, Snake);

    this.head = null;
    this.direction = _baseConfig_js__WEBPACK_IMPORTED_MODULE_3__["default"].baseDirection;
    this.timer = null;
    this.length = _baseConfig_js__WEBPACK_IMPORTED_MODULE_3__["default"].length;
    this.foodx = foodx;
    this.foody = foody;
  }
  ...
  _createClass(Snake, [{
    ...
    value: function initSnake() {
      ...
      for (var index = 0; index < this.length; index++) {
        var snakeItem = new _snakeItemClass_js__WEBPACK_IMPORTED_MODULE_2__["SnakeItem"](index, 0);

        if (curItem !== null) {
          curItem.setPrev(snakeItem);
        }
    ...
    key: "move",
    value: function move() {
      var newX = this.getNextPosition().x;
      var newY = this.getNextPosition().y;
      this.getFood();
      var item = this.head;
    ...
    key: "changeDirection",
    value: function changeDirection(target) {
    ...
    value: function startMove() {
      ...
      this.timer = setInterval(function () {
        ...
        _this.move();
      }, _baseConfig_js__WEBPACK_IMPORTED_MODULE_3__["default"].time);
    }
  }, {
    key: "stopMove",
    ...
    value: function gameOver() {
      ...
      gameTips.text('Game Over! 按F5键重新开始！');
    }
  }, {
    key: "getFood",
    value: function getFood() {
      if (this.head.x === this.foodx && this.head.y === this.foody) {
        jquery__WEBPACK_IMPORTED_MODULE_4___default()('.food').remove();
        this.addItem();
        food.initFood();
        this.foodx = food.x;
        this.foody = food.y;
    ...
    value: function addItem() {
      this.length++;
      var item = new _snakeItemClass_js__WEBPACK_IMPORTED_MODULE_2__["SnakeItem"](-1, -1);
      var tail = this.head;
...
/***/ "./src/js/snakeItemClass.js":
/*!**********************************!*\
  !*** ./src/js/snakeItemClass.js ***!
  \**********************************/
/*! exports provided: SnakeItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SnakeItem", function() { return SnakeItem; });
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.define-property */ "./node_modules/core-js/modules/es.object.define-property.js");
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
...
var gameBox = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.game-box');
var SnakeItem = /*#__PURE__*/function () {
  function SnakeItem(x, y) {
    _classCallCheck(this, SnakeItem);
  ...
  _createClass(SnakeItem, [{
    key: "setNext",
    value: function setNext(nextItem) {
      this.next = nextItem;
      nextItem.prev = this;
    }
  }, {
    key: "setPrev",
    value: function setPrev(prevItem) {
      this.prev = prevItem;
      prevItem.next = this;
    }
  }, {
    ...
    value: function moveForward() {
      ...
      if (this.prev !== null) {
        this.reDraw(this.prev.x, this.prev.y);
      }
    }
  }]);
